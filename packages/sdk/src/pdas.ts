...
export function deriveSurveyPda(surveyId: Uint8Array, programId: PublicKey): [PublicKey, number] {
...
export function deriveVaultPda(surveyPda: PublicKey, programId: PublicKey): [PublicKey, number] {
